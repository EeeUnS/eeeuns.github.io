...
그리고 남은 내용들이 C언어가 cpu에 작동하기까지라는 주제에 좀 벗어난 얘기들이라 별개의 [posting](https://eeeuns.github.io/2024/09/03/reducebuild/)으로 올리려고한다.
...
자세히는 보통 컴파일러 수업에서 다루는 구문 분석이 주요 핵심으로 작용한다.
