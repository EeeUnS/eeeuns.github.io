...
1. 포인터가 가르키는 객체는 thread-safe하지 않다.
...
2. ref counting에서 atomic연산 또한 데이터 경합이 생기면, 성능이 떨어진다.
...
4. shared_ptr 또한 결국 thread safe 하지않다.

[!img.png](/images/shared_ptr/Untitled%207.png)
