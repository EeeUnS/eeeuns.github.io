...
![quick sort 작동 예시@reference1](./assets/img/quicksortq1.png)
...
![증가함수의 대소비교@reference1](./assets/img/quicksortq5.png)
...
트리@reference1](./assets/img/quicksortq2.png)
...
![9:1로 분할하는 재귀 트리@reference1](./assets/img/quicksortq9.png)
...
![최악,최선이 번갈아 나타나는 재귀
트리@reference1](./assets/img/quicksortq3.png)
